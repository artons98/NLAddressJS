(function (global) {
  ...
  const API_ENDPOINT = 'https://www.openpostcode.nl/api/address';
  ...
  function lookupAddress(groupId) {
    ...
    const url = `${API_ENDPOINT}?postcode=${encodeURIComponent(postalcode)}&huisnummer=${encodeURIComponent(number)}`;
